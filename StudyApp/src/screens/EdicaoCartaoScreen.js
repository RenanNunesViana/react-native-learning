...
const EdicaoCartaoScreen = ({route, navigation}) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <Button title="Escolher Data" onPress={changeDataPicker} color="#32cd32" />
            <DateTimePickerModal
                isVisible={mostraDataPicker}
                mode="dateTime"
                onConfirm={(data) => {
                    confirmarDataTermino(data)
                    changeDataPicker()
                }}
                onCancel={changeDataPicker}
            />
            ...
            >
                <Picker.Item label="Backlog" value="Backlog"></Picker.Item>
                <Picker.Item label="Em Progresso" value="in_progress"></Picker.Item>
                <Picker.Item label="Concluído" value="done"></Picker.Item>
            </Picker>
